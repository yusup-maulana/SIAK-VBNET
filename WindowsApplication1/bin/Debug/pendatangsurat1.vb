...
Public Class pendatangsurat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIAK.pendatangsurat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpendatangsurat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pendatangsurat = New pendatangsurat()
        rpt.Site = Me.Site
        Return rpt
    End Function
